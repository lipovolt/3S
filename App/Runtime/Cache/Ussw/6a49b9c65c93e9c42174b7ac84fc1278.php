...
<dl>
	...
	<dd><a href="<?php echo U('Ussw/Ussw/usswInbound');?>"  mark="Outbound">美国自建仓入库单</a></dd>
...
<dl>
	...
	<dd><a href="<?php echo U('Ussw/Ussw/usswInbound');?>"  mark="Outbound">新建美国自建仓入库单</a></dd>
		...
		<div>
			<div class="tab-content">	
				<table id="tablelist" class="tablelist">
					...
					<?php if(is_array($usswInbounds)): $i = 0; $__LIST__ = $usswInbounds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<a href="<?php echo U('Ussw/Ussw/showItems',array('id'=>$vo['id']));?>">产品详情</a>
						</td>
