...
<title>USPS Priority Postage</title>
<!-- InstanceEndEditable -->
...
<dl>
	...
	<div id="ProductInfo" class="main">
		<div class="tab-content">	
			<div class="sidenav-hd"><strong>USPS Priority 邮费设置</strong></div>
			<form method="POST" id="updatePriority" name="updatePriority" action="<?php echo U('Ussw/Postage/updatePriority');?>">
			...
			<table id="tablelist" class="tablelist">
				...
				<tr>
					<?php if(is_array($postage)): $i = 0; $__LIST__ = $postage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><input type="hidden" id="lbs<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITY_LBS')]); ?>" name="lbs<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITY_LBS')]); ?>" value="<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITY_LBS')]); ?>"> <?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITY_LBS')]); ?></td>
						<td><?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITY_GR')]); ?></td>
						<td><input type="text" id="fee<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITY_LBS')]); ?>" name="fee<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITY_LBS')]); ?>" value="<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITY_FEE')]); ?>" style="width:60px;"/> </td>
