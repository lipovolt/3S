...
<dl>
	...
	<div id="itemInbound" class="main">
		...
		<form name="search_inbound" id="search_inbound" action="<?php echo U('Ussw/Inbound/insertSingleItem');?>" method="POST" >			
        ...
        <br />
        <br />
        <form name="search_inbound" id="search_inbound" action="<?php echo U('Ussw/Inbound/insertMultiItem');?>" method="POST" >			
		<div class="block-indent search-area">
