...
<div class="sidenav">
	...
	<div id="itemInbound" class="main">
		...
		<form name="search_outbound" id="search_outbound" action="<?php echo U('Ussw/Ussw/itemOutbound');?>" method="POST">			
        ...
        <br />
        <br />
        <form name="search_outbound" id="search_outbound" action="<?php echo U('Ussw/Ussw/itemBatchOutbound');?>" method="POST">			
		<div class="block-indent search-area">
