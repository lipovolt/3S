    ...
    <div class="block-outer-bd viewBaseCheckStatus">
        <div class="item">
            <div class="form-group">
                ...
                <div class="control-wrap">
                	<span><?php echo ($order[0]['id']); ?></span>
               	</div>
            </div>
            <div class="form-group">
                <label for="" class="control-label">状态：</label>
                <div class="control-wrap">
                	<span><?php echo ($order[0]['status']); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="item">
            <div class="form-group">
                ...
                <div class="control-wrap">
                	<span>greatgoodshop</span>
                </div>
            </div>
            <div class="form-group">
                <label for="" class="control-label">ebay买家ID：</label>
                <div class="control-wrap">
                	<span><?php echo ($order[0]['buyerid']); ?></span>
                </div>
            </div>
        </div>        
        ...
        <div class="item">
            <div class="form-group">
                ...
                <div class="control-wrap">
                	<span><?php echo ($order[0]['saleno']); ?></span>
                </div>
            </div>
            <div class="form-group">
                <label for="" class="control-label">派送供应商：</label>
                <div class="control-wrap">
                	<span><?php echo ($order[0]['shippingcompany']); ?></span>
                </div>
            </div>
        </div>
       <div class="item">
            <div class="form-group">
                ...
                <div class="control-wrap">
                	<span><?php echo ($order[0]['shippingway']); ?></span>
                </div>
            </div>
            <div class="form-group">
                <label for="" class="control-label">快递单号：</label>
                <div class="control-wrap">
                	<span><?php echo ($order[0]['trackingnumber']); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="block-indent">
		<div class="item">
		     <div class="form-group">
		         ...
		         <div class="control-wrap">
		         	<span><?php echo ($order[0]['buyername']); ?></span>
		         </div>
		     </div>
		     ...
		     <div class="form-group">
		         ...
		         <div class="control-wrap">
		         	<span><?php echo ($order[0]['buyercountry']); ?></span>
		         </div>
		     </div>
		</div>
		...
		<div class="item">
		     <div class="form-group">
		         ...
		         <div class="control-wrap">
		         	<span><?php echo ($order[0]['buyertel']); ?></span>
		         </div>
		     </div>
		     <div class="form-group">
		         <label for="" class="control-label">收件人邮编：</label>
		         <div class="control-wrap">
		         	<span><?php echo ($order[0]['buyerzip']); ?></span>
		         </div>
		     </div>
		</div>
		<div class="item">
		     <div class="form-group">
		         ...
		         <div class="control-wrap">
		         	<span><?php echo ($order[0]['buyerstate']); ?></span>
		         </div>
		     </div>
		     <div class="form-group">
		         <label for="" class="control-label">收件人城市：</label>
		         <div class="control-wrap">
		         	<span><?php echo ($order[0]['buyercity']); ?></span>
		         </div>
		     </div>
		</div>
		<div class="item">
		     <div class="form-group">
		         ...
		         <div class="control-wrap">
		         	<span><?php echo ($order[0]['buyeremail']); ?></span>
		         </div>
		     </div>
		</div>
		<div class="item">
		     <div class="form-group">
		         ...
		         <div class="control-wrap">
		         	<span><?php echo ($order[0]['buyeraddress1']); ?></span>
		         </div>
		     </div>
		</div>
		<div class="item">
		     <div class="form-group">
		         ...
		         <div class="control-wrap">
		         	<span><?php echo ($order[0]['address2']); ?></span>
		         </div>
		     </div>
		</div>
			</div>
...
<div class="block-outer">
	...
	<table  id="warehouseProduct" class="tablelist">              
			...
			<?php if(is_array($outboundOrderItems)): $i = 0; $__LIST__ = $outboundOrderItems;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="num"><?php echo ($vo["quantity"]); ?></td>
				<td><?php echo ($vo["itemno"]); ?></td>
				<td><?php echo ($vo["transactionno"]); ?></td>
				<td>
				</td>
