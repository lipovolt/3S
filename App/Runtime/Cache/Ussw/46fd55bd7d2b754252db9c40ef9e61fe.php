...
<title>Fedex Home Delivery Postage</title>
<!-- InstanceEndEditable -->
...
<dl>
	...
	<div id="ProductInfo" class="main">
		<div class="tab-content">	
			<div class="sidenav-hd"><strong>Fedex Home Delivery 邮费设置</strong></div>
			<form method="POST" id="updatePriority" name="updatePriority" action="<?php echo U('Ussw/Postage/updateFedexHome');?>">
			...
			<table id="tablelist" class="tablelist">
				...
				<tr>
					<?php if(is_array($postage)): $i = 0; $__LIST__ = $postage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><input type="hidden" id="lbs<?php echo ($vo[C('DB_USSW_POSTAGE_FEDEX_HOME_LBS')]); ?>" name="lbs<?php echo ($vo[C('DB_USSW_POSTAGE_FEDEX_HOME_LBS')]); ?>" value="<?php echo ($vo[C('DB_USSW_POSTAGE_FEDEX_HOME_LBS')]); ?>"> <?php echo ($vo[C('DB_USSW_POSTAGE_FEDEX_HOME_LBS')]); ?></td>
						<td><?php echo ($vo[C('DB_USSW_POSTAGE_FEDEX_HOME_GR')]); ?></td>
						<td><input type="text" id="fee<?php echo ($vo[C('DB_USSW_POSTAGE_FEDEX_HOME_LBS')]); ?>" name="fee<?php echo ($vo[C('DB_USSW_POSTAGE_FEDEX_HOME_LBS')]); ?>" value="<?php echo ($vo[C('DB_USSW_POSTAGE_FEDEX_HOME_FEE')]); ?>" style="width:60px;"/> </td>
