	...
	<dd ><a href="<?php echo U('Ussw/Storage/add');?>">新增库存</a></dd>
		...
		<div class="content">
			 <table id="tablelist" class="tablelist">
								...
								<?php if(is_array($errorInFile)): $k = 0; $__LIST__ = $errorInFile;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
									<td><div class="tl"><?php echo ($k+1); ?></div></td>
									<td><div class="tl"><?php echo ($vo); ?></div></td>
