...
<dl>
	...
	<div id="itemInbound" class="main">
		...
		<form name="search_inbound" id="search_inbound" action="<?php echo U('Ussw/Storage/insertSingleItem');?>" method="POST" >			
		<div class="block-indent search-area">
			...
			<div class="form-group">
				...
				<label for="" class="control-label" name="sku" id="sku" >货号</label>
				<div class="control-wrap">
					<input type="text" name="sku" id="sku" value="">
				</div>
			</div>
			<button class="btn btn-s btn-blue" onmousedown="return checkSingle()" onclick="search_inbound.submit();">
        ...
        <br />
        <br />
        <form name="search_inbound" id="search_inbound" action="<?php echo U('Ussw/Storage/insertMultiItem');?>" method="POST" >			
		<div class="block-indent search-area">
			...
			<div class="form-group">
				...
				<label for="" class="control-label" name="quantity" id="quantity" >数量</label>
				<div class="control-wrap">
					<input type="text" name="quantity" id="quantity" value="">
				</div>
			</div>
			<button class="btn btn-s btn-blue" onmousedown="return checkMulti()" onclick="search_inbound.submit();">
				<i class="icon search"></i>
				<i class="vline-inline"></i>
				<span>入库</span>
			</button>
