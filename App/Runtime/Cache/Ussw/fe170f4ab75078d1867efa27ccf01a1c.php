...
<title>USPS Priority Flat Rate Postage</title>
<!-- InstanceEndEditable -->
...
<dl>
	...
	<div id="ProductInfo" class="main">
		<div class="tab-content">	
			<div class="sidenav-hd"><strong>USPS Priority Flat Rate 邮费设置</strong></div>
			<form method="POST" id="updatepriorityFlatRate" name="updatepriorityFlatRate" action="<?php echo U('Ussw/Postage/updatepriorityFlatRate');?>">
			...
			<table id="tablelist" class="tablelist">
				...
				<tr>
					<?php if(is_array($postage)): $i = 0; $__LIST__ = $postage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><input type="hidden" id="id<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITYFLATRATE_ID')]); ?>" name="id<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITYFLATRATE_ID')]); ?>" value="<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITYFLATRATE_ID')]); ?>"> <?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITYFLATRATE_NAME')]); ?></td>
						<td><input type="text" id="fee<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITYFLATRATE_ID')]); ?>" name="fee<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITYFLATRATE_ID')]); ?>" value="<?php echo ($vo[C('DB_USSW_POSTAGE_PRIORITYFLATRATE_FEE')]); ?>" style="width:60px;"/> </td>
