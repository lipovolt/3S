...
<dl>
	...
	<div id="itemInbound" class="main">
		...
		<form name="search_outbound" id="search_outbound" action="<?php echo U('Ussw/Outbound/itemOutbound');?>" method="POST">			
		<div class="block-indent search-area">
			<div><strong>单品出库</strong></div>
        ...
        <br />
        <br />
        <form name="search_outbound" id="search_outbound" action="<?php echo U('Ussw/Outbound/itemBatchOutbound');?>" method="POST">			
		<div class="block-indent search-area">
			<div><strong>批量出库</strong></div>
			<div class="form-group">
				<label for="" class="control-label" name="position" id="position" >货位</label>
				<div class="control-wrap">
					<input type="text" name="position" id="position" value="">
