			...
			<div class="tab-content">
				...
				<table id="tablelist" class="tablelist">
					...
					<?php if(is_array($items)): $i = 0; $__LIST__ = $items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form method="POST" id="edit_productInfo" action="<?php echo U('Ussw/Inbound/updateInboundPackage');?>">
						...
						<tr>
							<td><div class="tl"><input type="text"  id="<?php echo C('DB_USSW_INBOUND_PACKAGE_PACKAGE_NO');?>" name="<?php echo C('DB_USSW_INBOUND_PACKAGE_PACKAGE_NO');?>" value="<?php echo ($vo[C('DB_USSW_INBOUND_PACKAGE_PACKAGE_NO')]); ?>" style="width:80px;"/></div></td>
