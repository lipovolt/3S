								...
								<div class="block-bd">
									<div class="block-indent" style="overflow:hidden;">
										<div style="float:left;width:456px;">
											<p>请<a href="http://www.lipovolt.com/3s/Download/Download_Purchase_Template.xls" style="color: #6495ED">点击此处</a>下载采购导入模板，填写产品信息完成后，上传数据。</p>
											<div>
												 <form action="<?php echo U('Purchase/Purchase/import');?>" method="post" enctype="multipart/form-data">
											...
											<p>
												<span class="notice-s">导入只支持XLS格式文件</span>
											</p>
										</div>										
									</div>															
								</div>
