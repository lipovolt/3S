...
<dl>
	...
	<div id="Supplier" class="main">
		<form method="POST" id="add_new_supplier" action="<?php echo U('Purchase/Supplier/add');?>">
					...
					<div class="item">
                        <div class="form-group">
							...
							<div class="control-wrap">
								<input type="text"  id="<?php echo C('DB_SUPPLIER_COMPANY');?>" name="<?php echo C('DB_SUPPLIER_COMPANY');?>" value="" />
							</div>
						</div>
						<div class="form-group checkbox">
							<label for="IsBattery" class="control-label">联系人</label>
							<div class="control-wrap">
								<input type="text"  id="<?php echo C('DB_SUPPLIER_PERSON');?>" name="<?php echo C('DB_SUPPLIER_PERSON');?>" value="" />
							</div>							
						</div>
					</div>
					<div class="item">
						<div class="form-group">
							...
							<div class="control-wrap">
								<input type="text" name="<?php echo C('DB_SUPPLIER_WANGWANG');?>" id="<?php echo C('DB_SUPPLIER_WANGWANG');?>" value="" />
							</div>
						</div>
						<div class="form-group">
							<label for="EName" class="control-label">QQ</label>
							<div class="control-wrap">
								<input type="text" name="<?php echo C('DB_SUPPLIER_QQ');?>" id="<?php echo C('DB_SUPPLIER_QQ');?>" value="" />
							</div>
						</div>
					</div>
					<div class="item">
                        <div class="form-group">
							...
							<div class="control-wrap">
								<input type="text"  id="<?php echo C('DB_SUPPLIER_TEL');?>" name="<?php echo C('DB_SUPPLIER_TEL');?>" value="" />
							</div>
						</div>
						<div class="form-group">
							<label for="length" class="control-label">网址</label>
							<div class="control-wrap">
								<input type="text"  id="<?php echo C('DB_SUPPLIER_WEBSITE');?>" name="<?php echo C('DB_SUPPLIER_WEBSITE');?>" value="" />
							</div>
						</div>
					</div>
                    <div class="item">
                        <div class="form-group">
							...
							<div class="control-wrap">
								<input type="text"  id="<?php echo C('DB_SUPPLIER_ADDRESS');?>" name="<?php echo C('DB_SUPPLIER_ADDRESS');?>" value="" />
							</div>
						</div>
                    </div>
				</div>
		...
		<div class="item tc">
			...
			<button class="btn btn-blue btn-s" id="saveProductInfo" onclick="return checkForm()">添加</button>
		</div>
	</form> 
	</div>
