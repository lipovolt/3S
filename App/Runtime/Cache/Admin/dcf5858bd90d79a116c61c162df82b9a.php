	...
	<dd><a href="#" >权限分配</a></dd>
		...
		<div class="content">
			<div class="form-group">
				<label class="control-label">添加<?php echo ($type); ?></label>
			</div>
							...
							<div class="inline-block block-indent">
								<div class="form-group">
									...
									<div class="control-wrap">
										<input type="text" name="<?php echo C('DB_NODE_NAME');?>" value="" id="<?php echo C('DB_NODE_NAME');?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label"><?php echo ($type); ?>描述:</label>
									<div class="control-wrap">
										<input type="text" name="<?php echo C('DB_NODE_TITLE');?>" value="" id="<?php echo C('DB_NODE_TITLE');?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label">是否开启:</label>
									<div class="control-wrap">
										<select name="<?php echo C('DB_NODE_STATUS');?>"  id="<?php echo C('DB_NODE_STATUS');?>">
								...
								<div class="form-group">
									...
									<div class="control-wrap">
										<input type="text" name="<?php echo C('DB_NODE_SORT');?>" value="1" id="<?php echo C('DB_NODE_SORT');?>"/>
									</div>
								</div>
								<div class="item tc">
									<input type="hidden" name="<?php echo C('DB_NODE_PID');?>" value="<?php echo ($pid); ?>" id="<?php echo C('DB_NODE_PID');?>"/>
									<input type="hidden" name="<?php echo C('DB_NODE_LEVEL');?>" value="<?php echo ($level); ?>" id="<?php echo C('DB_NODE_LEVEL');?>"/>
									<a class="btn btn-s btn-grey" href="javascript:history.back();">返回</a>
									<button class="btn btn-blue btn-s" id="saveNode">添加</button>
								</div>
							</div>
						</div>
					</div>
