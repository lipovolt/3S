					...
					<div class="form-group">
						...
						<div class="control-wrap">
							<select name="keyword" id="keyword" data-value="">
								<option value="<?php echo C('DB_ROLE_ID');?>">角色编号</option>
								<option value="<?php echo C('DB_ROLE_NAME');?>">角色名称</option>
							</select>
						</div>
						<div class="control-wrap">
		...
		<div>
			<div class="tab-content">	
				<table id="tablelist" class="tablelist">
					<tr>
						<th width="110">角色编号</th>
						<th><div class="tl">角色名称</div></th>
						<th><div class="tl">角色描述</div></th>
						<th><div class="tl">父角色编号</div></th>
					...
					<?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><div class="tl"><?php echo ($vo[C('DB_ROLE_ID')]); ?></div></td>
						<td><div class="tl"><?php echo ($vo[C('DB_ROLE_NAME')]); ?></div></td>						
						<td><div class="tl"><?php echo ($vo[C('DB_ROLE_REMARK')]); ?></div></td>
						<td><div class="tl"><?php echo ($vo[C('DB_ROLE_PID')]); ?></div></td>						
						<td><div class="tl"><?php echo ($vo[C('DB_ROLE_STATUS')]); ?></div></td>
						<td>
							<a href="<?php echo U('Admin/Rbac/access',array(C('DB_ROLE_ID')=>$vo[C('DB_ROLE_ID')]));?>">配置权限</a>
						</td>
