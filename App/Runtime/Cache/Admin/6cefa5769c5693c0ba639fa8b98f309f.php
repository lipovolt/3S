							...
							<div class="inline-block block-indent">
								<div class="form-group">
									...
									<div class="control-wrap">
										<input type="text" name="<?php echo C('DB_3S_USER_USERNAME');?>" value="" id="<?php echo C('DB_3S_USER_USERNAME');?>"/>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label">密码:</label>
									<div class="control-wrap">
										<input type="text" name="<?php echo C('DB_3S_USER_PASSWORD');?>" value="" id="<?php echo C('DB_3S_USER_PASSWORD');?>"/>
									</div>
								</div>
								<div>
									<label class="control-label">角色:</label>
									<div id="roles">
										<select name="<?php echo C('DB_ROLE_ID');?>[]"  id="<?php echo C('DB_ROLE_ID');?>">
											<option value="" selected>请选择角色</option>
											<?php if(is_array(${C('DB_ROLE')})): foreach(${C('DB_ROLE')} as $key=>$v): ?><option value="<?php echo ($v[C('DB_ROLE_ID')]); ?>"><?php echo ($v[C('DB_ROLE_NAME')]); ?>(<?php echo ($v[C('DB_ROLE_REMARK')]); ?>)</option><?php endforeach; endif; ?>					
										</select>
										<span class='add-role'>增加角色</span>
									</div>	
								</div>
								<div id="buttons">
