...
class MetadataAction extends CommonAction{
	...
	public function updateSellerAccount(){
		...
		if($this->checkUpdatedSellerAccount($sa, $_POST)!=null){
			...
			$sa[C('DB_SELLER_ACCOUNT_QUESTION1')] = $_POST[C('DB_SELLER_ACCOUNT_QUESTION1')];
			$sa[C('DB_SELLER_ACCOUNT_ANSWER1')] = $_POST[C('DB_SELLER_ACCOUNT_ANSWER1')];
			$sa[C('DB_SELLER_ACCOUNT_QUESTION2')] = $_POST[C('DB_SELLER_ACCOUNT_QUESTION2')];
			...
			$sa[C('DB_SELLER_ACCOUNT_ADDRESS')] = $_POST[C('DB_SELLER_ACCOUNT_ADDRESS')];
			$sa[C('DB_SELLER_ACCOUNT_HOLDER_NAME')] = $_POST[C('DB_SELLER_ACCOUNT_HOLDER_NAME')];
