        ...
        if(!empty($_FILES)){
            ...
            if($this->verifyWinitOutboundColumnName($firstRow)){
                ...
                for($i=2;$i<=$highestRow;$i++){
                    ...
                    $woo[C('DB_WINIT_OUTBOUND_SELLER_ID')]=$objPHPExcel->getActiveSheet()->getCell("G".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_ID')]=$objPHPExcel->getActiveSheet()->getCell("H".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_NAME')]=$objPHPExcel->getActiveSheet()->getCell("I".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_TEL')]=$objPHPExcel->getActiveSheet()->getCell("J".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_EMAIL')]=$objPHPExcel->getActiveSheet()->getCell("K".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_ADDRESS1')]=$objPHPExcel->getActiveSheet()->getCell("L".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_ADDRESS2')]=$objPHPExcel->getActiveSheet()->getCell("M".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_CITY')]=$objPHPExcel->getActiveSheet()->getCell("N".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_STATE')]=$objPHPExcel->getActiveSheet()->getCell("O".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_COUNTRY')]=$objPHPExcel->getActiveSheet()->getCell("Q".$i)->getValue();
                    $woo[C('DB_WINIT_OUTBOUND_BUYER_ZIP')]=$objPHPExcel->getActiveSheet()->getCell("P".$i)->getValue();
                    $index=$winitOutboundOrder->add($woo);
                    for($j='T'; $j!=$highestColumn;$j++) { 
